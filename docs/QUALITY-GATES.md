...
- [ ] Branch `feature/<NNNN-slug>` criada a partir de `main` atualizada; PR aberto.
- [ ] Plano de implementação foi aprovado pelo usuário antes do primeiro commit de código.
