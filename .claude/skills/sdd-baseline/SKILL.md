...
4. Se `docs/BASELINE.md` foi criado/atualizado, mostre um resumo ao usuário (visão geral do
   ...
   agora usar essa base para desenhar o TRD (`/sdd-trd`).

## Quando usar sem o agente

Se o Agent tool não estiver disponível, siga `.claude/agents/codebase-archaeologist.md`
diretamente — nunca corrija/refatore o que encontrar, só documente.
