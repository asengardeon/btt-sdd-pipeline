...
2b. **Feature com UI → ofereça wireframes/protótipos antes do PRD, com apoio de `ux-designer`.**
   ...
   **Sempre que este passo dispara** (a feature tem alteração de UI de verdade — o mesmo gate
   acima, não uma condição extra), a consultoria de `ux-designer` (modo "consultoria de PRD",
   `.claude/agents/ux-designer.md`) roda também, **independente da resposta do usuário sobre ver
   ...
   confunda com o modo revisão pós-implementação (`/sdd-ux-review`, etapa 4b), que continua
...
(oferta de wireframes/protótipos, incluindo a consultoria de `ux-designer`) continua sendo sua
responsabilidade, já que ele depende de ferramentas (`AskUserQuestion`, `Artifact`, skill `design`,
Agent tool) que este agente sozinho não tem. Sem Agent tool, siga
`.claude/agents/ux-designer.md`, seção "Processo (modo consultoria de PRD)", você mesmo, em vez de
pular a consultoria.
