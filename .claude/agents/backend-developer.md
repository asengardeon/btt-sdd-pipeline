...
de como as duas partes se encaixam. Os gates de `docs/QUALITY-GATES.md` (seção "Implementação")
...
5. **Só depois de concluídos todos os incrementos da sua trilha**, rode a suíte completa com
   ...
   momento, atualize a coluna Status das tarefas de backend desta fatia no TRD para
