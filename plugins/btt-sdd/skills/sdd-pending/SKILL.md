...
Não aciona nenhum agente — é um utilitário de leitura, como `/btt-sdd:sdd-status`, mas focado só nos
...
5. Se o usuário pedir para resolver um item específico (responder a pergunta agora), colete a
   resposta e acione `/btt-sdd:sdd-amend` para registrar a resolução no artefato correto — não edite o
