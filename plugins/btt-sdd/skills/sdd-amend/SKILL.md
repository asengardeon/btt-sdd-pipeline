...
1. Identifique a feature (slug) e qual artefato muda: `prd.md`, `trd.md`, a implementação em
   ...
   usuário (use `/btt-sdd:sdd-pending` primeiro se a emenda é para resolver um item VALIDAR DEPOIS
...
5. Para cada etapa afetada, registre no "Log de revisões" do respectivo artefato downstream que
   ...
   usuário quais comandos (`/btt-sdd:sdd-trd`, `/btt-sdd:sdd-implement`, `/btt-sdd:sdd-qa`, `/btt-sdd:sdd-sre`) precisam ser
