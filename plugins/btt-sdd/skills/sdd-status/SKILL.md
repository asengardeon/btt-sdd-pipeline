...
2. Para cada um, verifique a presença de: `prd.md`, `trd.md`, `qa-report.md`,
...
7. Se um `qa-report.md`, `security-review.md` ou `sre-review.md` existir com veredito reprovado,
   sinalize isso explicitamente em vez de tratar como etapa concluída.
