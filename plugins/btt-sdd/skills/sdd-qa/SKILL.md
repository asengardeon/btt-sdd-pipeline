...
2. Confirme que existe `specs/<slug>/code-review.md` com veredito aprovado (ou aprovado com
   ressalvas aceitas pelo usuário). Se não existir, sugira `/btt-sdd:sdd-code-review` primeiro; se
   existir reprovado, sugira `/btt-sdd:sdd-implement` para tratar os achados antes de rodar o QA.
