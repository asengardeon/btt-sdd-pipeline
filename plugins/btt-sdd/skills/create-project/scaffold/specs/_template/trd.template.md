...
também onde ele entra (consumindo o adapter de entrada via o contrato da seção 7).
...
Schema, payloads de API, formato de eventos — o que for aplicável (além do contrato da seção 7,
se houver).
...
- Frontend (se aplicável): componentes/serviços testados com dublê do contrato da seção 7.
