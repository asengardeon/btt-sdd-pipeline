...
informe que a próxima etapa é `/btt-sdd:qa` com o agente `qa-engineer`. Se reprovado, informe
que a feature volta para `/btt-sdd:implement` com os achados listados.
