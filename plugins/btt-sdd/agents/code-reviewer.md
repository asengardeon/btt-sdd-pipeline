...
arquitetura pretendida. Sem PR/branch, não há o que revisar — devolva para `/btt-sdd:sdd-implement`.
...
informe que a próxima etapa é `/btt-sdd:sdd-qa` com o agente `qa-engineer`. Se reprovado, informe
que a feature volta para `/btt-sdd:sdd-implement` com os achados listados.
